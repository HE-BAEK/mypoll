...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        ...
        ### {"field이름":Widget객체}
        widgets = {
            "birth":forms.DateInput(attrs={"type":"date"}), #<input type='date'>
...
# 회원종보 수정 Form 정의 - UserChangeForm(username) 상속
class CustomUserChangeForm(UserChangeForm):

    class Meta:
        model = User
        fields = ['name', 'email', 'birth', 'profile_img']
        widgets = {
